  ...
  return (
    <div className="rounded-md border border-violet-200/60 bg-violet-50/40 dark:border-violet-900/40 dark:bg-violet-950/15 text-xs">
      ...
      >
        ...
        <span className="font-mono font-medium text-violet-700 dark:text-violet-400">{tool.name}</span>
        {open ? (
      ...
      {open && (
        <div className="border-t border-violet-200/50 dark:border-violet-900/30 px-3 py-2 space-y-2">
          {tool.input && (
            <div>
              <div className="mb-1 text-[10px] font-semibold uppercase tracking-wider text-violet-500/70">Input</div>
          ...
          {tool.output && (
            <div>
              <div className="mb-1 text-[10px] font-semibold uppercase tracking-wider text-violet-500/70">Output</div>
              <pre className="max-h-48 overflow-y-auto whitespace-pre-wrap break-all font-mono text-[11px] text-violet-900/80 dark:text-violet-200/70">
                {tool.output}
              </pre>
            </div>
