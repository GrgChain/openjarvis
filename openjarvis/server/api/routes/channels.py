...
from server.api.models import ChannelStatus, UpdateChannelRequest
...
def _get_enabled(ch_cfg: Any) -> bool:
    """Safely read 'enabled' from a channel config (Pydantic model or dict)."""
