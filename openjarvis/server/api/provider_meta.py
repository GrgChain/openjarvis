...
"""Server-managed per-provider metadata (models list, etc.).

Stored in ~/.nanobot/server_provider_meta.json separately from nanobot's
...
_META_PATH = Path.home() / ".nanobot" / "server_provider_meta.json"
