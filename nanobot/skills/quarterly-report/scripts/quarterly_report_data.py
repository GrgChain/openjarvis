...
class QuarterlyReportDataFetcher:
    ...
    def _get_financial_indicators(self, symbol):
        ...
        try:
            ...
            data_list = []
            records = indicator_rows.to_dict("records")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fetch detailed quarterly financial reports for A-share stocks.")
